...
(custom-set-variables
 ...
 '(elfeed-feeds '("https://www.reddit.com/r/virgin.rss"))
 '(package-selected-packages
   '(rust-mode elfeed dmenu timu-caribbean-theme kuronami-theme php-mode tron-legacy-theme exwm haskell-mode evil emms emmet-mode moe-theme dracula-theme)))
(custom-set-faces
